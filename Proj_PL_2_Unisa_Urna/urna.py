...
vereadores = {10001: {'nome':'Carla', 'partido': 'Partido Democrata', 'votos': 0},
              ...
              10004: {'nome':'Francisco', 'partido': 'Partido Social', 'votos': 0},
              10005: {'nome':'Rafael', 'partido': 'Partido Social', 'votos': 0},
              10006: {'nome':'Janailto', 'partido': 'Partido Social', 'votos': 0},
              10007: {'nome':'Damião', 'partido': 'Partido Social', 'votos': 0},
              10008: {'nome':'Vanderlei', 'partido': 'Partido PC do B', 'votos': 0},
              10009: {'nome':'Wilhan', 'partido': 'Partido PC do B', 'votos': 0},
...
# Função para imprimir a "zerésima"
...
# Função para exibir candidatos disponíveis
def exibir_candidatos():
    print("\nCandidatos disponíveis:\n")
    print("Prefeitos:")
    for numero, candidato in prefeitos.items():
        print(f"{numero} - {candidato['nome']} ({candidato['partido']})")
    print("\nVereadores:")
    for numero, candidato in vereadores.items():
        print(f"{numero} - {candidato['nome']} ({candidato['partido']})")
    print()
...
# Menu inicial para o usuário escolher entre imprimir a zerésima, iniciar a votação ou exibir os candidatos
while True:
    print("1. Imprimir Zerésima")
    print("2. Iniciar Votação")
    print("3. Exibir Candidatos")
